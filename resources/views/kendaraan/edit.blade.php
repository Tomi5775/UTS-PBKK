                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('kendaraan.update', $kendaraan->no_pol) }}" method="POST" class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="no_pol" value="{{ old('no_pol', $kendaraan->no_pol) }}" class="form-control" id="no_pol" placeholder="No Polisi">
                            </div>
                            <div class="col-12">
                                <label for="no_mesin" class="form-label"><strong>No Mesin:</strong></label>
                                <input type="text" name="no_mesin" value="{{ old('no_mesin', $kendaraan->no_mesin) }}" class="form-control" id="no_mesin" placeholder="No Mesin">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="nama_mobil" value="{{ old('nama_mobil', $kendaraan->nama_mobil) }}" class="form-control" id="nama_mobil" placeholder="Nama Mobil">
                            </div>
                            <div class="col-12">
                                ...
                                <select name="merek" class="form-control" id="merek">
                                    ...
                                    <option value="toyota" {{ old('merek', $kendaraan->merek) == 'toyota' ? 'selected' : '' }}>Toyota</option>
                                    <option value="daihatsu" {{ old('merek', $kendaraan->merek) == 'daihatsu' ? 'selected' : '' }}>Daihatsu</option>
                                </select>
                            </div>
                            <div class="col-12">
                                <label for="kapasitas" class="form-label"><strong>Kapasitas:</strong></label>
                                <input type="text" name="kapasitas" value="{{ old('kapasitas', $kendaraan->kapasitas) }}" class="form-control" id="kapasitas" placeholder="Kapasitas">
                            </div>
