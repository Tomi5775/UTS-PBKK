    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Tambah Penyewa</h5>
                        ...
                        <form action="{{ route('penyewa.store') }}" method="POST" class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="nama_penyewa" class="form-control" id="nama_penyewa" placeholder="Nama Penyewa" required>
                            </div>
                            <div class="col-12">
                                <label for="alamat" class="form-label"><strong>Alamat:</strong></label>
                                <textarea class="form-control" id="alamat" name="alamat" style="height:150px" placeholder="Alamat" required></textarea>
                            </div>
                            <div class="col-12">
