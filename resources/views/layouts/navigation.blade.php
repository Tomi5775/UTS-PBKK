<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('sewa.index')" :active="request()->routeIs('sewa.*')">
                {{ __('Sewa') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('penyewa.index')" :active="request()->routeIs('penyewa.*')">
                {{ __('Penyewa') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('invoice.index')" :active="request()->routeIs('invoice.*')">
                {{ __('Invoice') }}
            </x-responsive-nav-link>
